...
svm = SGDClassifier(loss='hinge')
    ...
    \begin{itemize}
        \item Gini impurity ($I_G$).
        \item Entropy ($I_H$).
        \item Classification error ($I_E$).
    \end{itemize}
    ...
    \begin{exa}
        In a binary class setting, the entropy is 0 is $p( i = 0 | t) = 1$ or $p( i = 0| t) = 0$. If the classes are distributed uniformly with $p( i = 0 | t) = \frac{1}{2}$ or $p( i = 0| t) = \frac{1}{2}$, the entropy is 1. Therefore, we can say that the entropy criterion attempts to maximize tue mutual information in the tree.
    \end{exa}
    ...
    \begin{center}
        \textit{The Gini impurity can be understood as a criterion to minimize the probability of misclassification.}
    \end{center}
