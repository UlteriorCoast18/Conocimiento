\contentsline {lstlisting}{\numberline {2.1}Python Perceptron Rule Implementation.}{21}{lstlisting.2.1}%
\contentsline {lstlisting}{\numberline {2.2}Read Dataset from UCI.}{25}{lstlisting.2.2}%
\contentsline {lstlisting}{\numberline {2.3}Extraction and Visualization of Iris Dataset.}{25}{lstlisting.2.3}%
\contentsline {lstlisting}{\numberline {2.4}Training the Perceptron Algorithm with the Iris Dataset}{26}{lstlisting.2.4}%
\contentsline {lstlisting}{\numberline {2.5}Plotting Regions on the Iris Dataset}{27}{lstlisting.2.5}%
\contentsline {lstlisting}{\numberline {2.6}Plotting the Perceptron Info on the Iris Dataset}{28}{lstlisting.2.6}%
\contentsline {lstlisting}{\numberline {2.7}Adaline Implementation in Python.}{34}{lstlisting.2.7}%
\contentsline {lstlisting}{\numberline {2.8}Computation of Partial Derivatives}{35}{lstlisting.2.8}%
\contentsline {lstlisting}{\numberline {2.9}Weight Update Optimization.}{35}{lstlisting.2.9}%
\contentsline {lstlisting}{\numberline {2.10}Loss for Two Different Learning Rates.}{36}{lstlisting.2.10}%
\contentsline {lstlisting}{\numberline {2.11}Standarization Using Numpy}{38}{lstlisting.2.11}%
