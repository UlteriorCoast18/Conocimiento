...
\begin{document}
    ...
    Intuitivamente lo que uno hace es defomar un arco en el otro en el espacio $X$, dejando fijos los puntos terminales fijos en todo momento de la deformación.
