...
\begin{document}
    ...
    \begin{cor}
        Si $\mathbb{S}^2$ es escrito como la unión de dos conjuntos cerrados $A_1,A_2,A_3\subseteq\mathbb{R}^3$, entonces uno de estos debe tener un par de puntos antipodales $\left\{x,-x\right\}$.
    \end{cor}
