...
\begin{document}
    ...
    \begin{proof}
        ...
        \end{equation*}
        para cualesquiera $\cf{U,V}{\mathcal{B}^{op}}{\mathcal{C}^{op}}$ funtores y $\cf{\beta}{U}{V}$ transformación natural.

        Consideremos $\cf{F,G,H}{\mathcal{B}}{\mathcal{C}}$ funtores y $\cf{\alpha}{F}{G}$ y $\cf{\beta}{G}{H}$ transformaciones naturales.

        Entonces, para todo $B\in\Obj{\mathcal{B}}$ se tiene
        \begin{equation*}
