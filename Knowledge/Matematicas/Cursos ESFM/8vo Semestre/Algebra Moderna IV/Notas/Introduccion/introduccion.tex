...
\begin{document}
    ...
    \begin{exa}
        El mapeo inclusión $\cf{i}{\mathbb{Z}}{\mathbb{Q}}$ es un monomorfismo en la categoría  $\Cat{Ring}^c$ y también por el ejemplo anterior, es un epimorfismo. Pero, no es un isomorfismo.
    \end{exa}

    \begin{proof}
        Veamos que es un epimorfismo, para ello hay que probar que si $\cf{f,g}{R}{\mathbb{Z}}$ son tales que
        \begin{equation*}
            i\circ f=i\circ g
        \end{equation*}
    ...
    La recíproca de la proposición anterior no es cierta en general, como prueba el ejemplo anterior. Lo cual da pie a la siguiente definición:
