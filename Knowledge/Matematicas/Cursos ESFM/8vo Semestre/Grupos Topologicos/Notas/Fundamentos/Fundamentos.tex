...
\begin{document}
    ...
    \begin{theor}
        Sea $\left\{G_i \right\}_{ i\in I}$ una familia de grupos topológicos y sea $H$ el subconjunto de $G=\prod_{ i\in I}G_i$ que consta de todos los $x=\left(x_i \right)_{ i\in I}$ tales que $x_i$ es el elemento identidad de $G_i$ para todo $i\in I$ salvo un número finito de índices; $H$ es entones un subgrupo normal denso en $G$.
    \end{theor}
