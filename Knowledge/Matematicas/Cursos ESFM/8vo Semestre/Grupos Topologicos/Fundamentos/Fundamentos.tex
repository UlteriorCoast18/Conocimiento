...
\begin{document}
    ...
    \begin{lema}
        Sea $G$ un grupo topológico, y sea $\mathcal{N}(e_G)$ una base local para la identidad del grupo $e_G$. Entonces las familias $\left\{xU\right\}$ y $\left\{Ux\right\}$, donde $x$ toma los valores en los elemntos de $G$ y $U$ varía sobre todos los elementos de $\mathcal{N}(e_G)$, son bases para la topología de $G$.
    \end{lema}
    ...
    \begin{proof}
        ...
        \end{equation*}
        Considere la función $\cf{f}{G}{G}$, $x\mapsto a^{-1}x$. Esta función es un homeomorfismo, el cual transforma a $W$ en $a^{-1}W$. Notemos que $e_G\in a^{-1}W$, pues el elemento $e_G=a^{-1}a\in a^{-1}W$. Como $\mathcal{N}(e_G)$ es una base local de $e_G$, entonces existe $U\in\mathcal{N}(e_G)$ tal que
        \begin{equation*}
