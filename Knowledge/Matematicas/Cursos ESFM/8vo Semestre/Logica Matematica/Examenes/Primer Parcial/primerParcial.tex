...
\begin{document}
    ...
    \begin{sol}
        ...
        \begin{enumerate}
            \item[De \textit{(a)}:]  Formemos el árbol a partir de la primera fórmula:
            \begin{center}
            ...
            \end{equation*}
            \item[De \textit{(b)}:] Nuevamente, formemos ahora el árbol a partir de la segunda fórmula:
            \begin{center}
                \begin{tikzpicture}[
            ...
            \end{equation*}
            \item[De \textit{(c)}:] Nuevamente, formemos ahora el árbol a partir de la terera fórmula:
            \begin{center}
                \begin{tikzpicture}[
                    level 1/.style={sibling distance = 4 cm},
