...
\begin{document}
    ...
    \begin{theor}[\textbf{Teorema de Completud de Gödel}]
        Dado un lenguaje de primer orden $\mathcal{L}$, un conjunto de $\mathcal{L}$-fórmulas y una fórmula $\varphi$, se tiene que:
        \begin{equation*}
            \Sigma\vDash\textup{ si y sólo si }\Sigma\vdash\varphi
        \end{equation*}
    \end{theor}
