...
\begin{document}
    ...
    \begin{cor}
        ...
        \begin{enumerate}
            \item $\Sigma\nvdash\varphi$ si y sólo si $\Sigma\cup\left\{ \varphi\right\}$ es consistente.
