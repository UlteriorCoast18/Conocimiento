...
\begin{document}
    ...
    \end{equation*}
    en esta fórmula, $v_5$ es llamada variable ligada, y $v_6$ es llamada libre.
    ...
    \begin{mydef}
        Considere el conjunto de fórmulas. Entonces $\cf{\free}{\textup{Conjunto de Fórmulas}}{\mathcal{P}(\textup{Variables})}$ tal que
        \begin{equation*}
