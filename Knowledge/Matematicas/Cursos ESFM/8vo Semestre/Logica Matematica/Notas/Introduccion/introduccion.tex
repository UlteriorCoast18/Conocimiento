...
\begin{document}
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tabular}{r l c l r}
                ...
                2) & $\neg(\neg\varphi$ & $\Rightarrow$ & $\neg\neg\psi)$ & 1 R.E. \\
                2) & $\neg(\neg(\neg\psi$ & $\Rightarrow$ & $\varphi))$ & 1 R.E. \\
                $|\longrightarrow$2) & $\neg\varphi$ & $\land$ & $\neg\psi$ &  \\
                $|\longrightarrow$2) & $\neg\varphi$ & $\land$ & $\neg\psi$ &  \\
                \hline
                & & $\therefore$ & $\neg \varphi\land\neg\psi$ & \\
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tabular}
        \end{center}
        ya que se sabe que existe una demostración de $\varphi\Rightarrow\psi$ a partir de $\Sigma$. Por tanto, $\Sigma\left\{\varphi \right\}\vdash\psi$.

        Para la suficiencia, supongamos que existe una demostración $(\varphi_1,....,\varphi_{n-1},\psi)$ de $\psi$ a partir de $\Sigma\cup\left\{\varphi\right\}$, y supongamos por hipótesis de inductiva que $\Sigma\vdash\varphi\Rightarrow\varphi_i$ para cada $i\in\natint{1,n-1}$.
        ...
        Consideremos el caso 3), por el lema anterior...

        Consideremos ahora el caso 4) ($i$ no es arbitrario, es alguno)
        \begin{center}
            \begin{tabular}{r l c l r}
                $\vdots$ & \vdots & \vdots & \vdots & Líneas de $\Sigma$ \\
                $k+i$) & $\varphi$ & $\Rightarrow$ & $\varphi_i$ & Pruebas de $\varphi\Rightarrow\varphi_{ n-1}$ para $i\in\natint{1,n-1}$\\
                $m+i$) & $\varphi$ & $\Rightarrow$ & $(\varphi_i\Rightarrow\psi)$ & Ax. 1\\
                $m+i+1$) & $(\varphi\Rightarrow(\varphi_i\Rightarrow\psi))$ & $\Rightarrow$ & $((\varphi\Rightarrow\varphi_i)\Rightarrow(\varphi\Rightarrow\psi))$ & Ax. 6\\
                $m+i+2$) & $(\varphi\Rightarrow\varphi_i)$ & $\Rightarrow$ & $(\varphi\Rightarrow\psi)$ & $m+i+1,m+i+2$ M.P.\\
                $m+i+3$) & $\varphi$ & $\Rightarrow$ & $\psi$ & $m+i+1,m+i+2$ M.P.\\
                \hline
                & & $\therefore$ & $\varphi\Rightarrow\psi$ & \\
            \end{tabular}
        \end{center}
    ...
    \begin{proof}
        Suficiencia, supongamos que $\Sigma\cup\left\{\neg\psi \right\}\vdash\varphi$. Esto es:
        \begin{center}
            \begin{tabular}{r l c l r}
                $\vdots$ & \vdots & \vdots & \vdots & Líneas de $\Sigma$ \\
                $|\longrightarrow k$) & $\neg\psi$ &  &  & Suposición \\
                $|\vdots$ & \vdots & \vdots & \vdots & Prueba de $|\varphi\land\neg\varphi$ \\
                $|m$) & $\varphi$ & $\land$ & $\neg\varphi$ & \\
                $|m+1$) & $\varphi$ &  &  & $m$ Simp.\\
                $|m+2$) & $\varphi$ & $\lor$ & $\psi$ & Ad.\\
                $|m+1$) & $\neg\varphi$ &  &  & $m$ Simp.\\
                $|m+2$) & $\psi$ &  &  & S.D.\\
                \hline
                $m+2$) & $\neg\psi$ & $\Rightarrow$ & $\psi$ & M.D.\\
                $m+2$) & $\psi$ & $\lor$ & $\psi$ & M.D.\\
                $m+2$) & $\psi$ & & & M.D.\\
                $m+2$) & $\psi$ & & & M.D.\\
                \hline
        ...
        Necesidad, supongamos que $\Sigma\vdash\psi$.
    \end{proof}
