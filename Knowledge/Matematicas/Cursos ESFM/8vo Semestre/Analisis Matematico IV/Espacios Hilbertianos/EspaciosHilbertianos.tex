...
\begin{document}
    ...
    \begin{theor}[Desigualdad de Cauchy-Schwartz]
        ...
        \begin{enumerate}
            \item Se cumple la desigualda de Cauchy-Schwartz:
            \begin{equation*}
            ...
            \begin{equation*}
                \norm{\vec{x}+\vec{y}}\leq\norm{\vec{x}}+\norm{\vec{y}},\quad\forall\vec{x},\vec{y}\in H
            \end{equation*}
            y la igualdad se da si y sólo si uno de los vectores es multiplo no negativo del otro.
        \end{enumerate}
    \end{theor}
    ...
    \begin{proof}
        ...
        Sean $\vec{x},\vec{y}\in H$. En el caso de que alguno de los vectores sea $\vec{0}$, el resultado es inmediato (ambos dan cero). Por lo cual, supongamos que ambos son no cero. Se tiene para todo $\lambda\in\mathbb{K}$ que
        \begin{equation}
            \begin{split}
        ...
        En particular, para
        \begin{equation*}
            %\lambda=\left\{t\frac{\pint{\vec{x}}{\vec{y}}}{\norm{\pint{\vec{x}}{\vec{y}}}} si $\pint{\vec{x}}{\vec{y}}\neq0$ y t si $\pint{\vec{x}}{\vec{y}}=0$ \right\}
        \end{equation*}
        ...
        \end{equation*}
        la primera igualdad implica que $\pint{\vec{x}}{\vec{y}}$ es real (en particular, $\geq0$) y la segunda implica que $\vec{x}$ y $\vec{y}$ son linealmente dependientes. Es decir, si y sólo si un vector es multiplo no negativo del otro.
    \end{proof}
    ...
    \begin{proof}
        Sean $\vec{x},\vec{y}\in H$ y, $\left\{\vec{x_n} \right\}$ y $\left\{\vec{y_n} \right\}$ dos sucesiones que convergen a $\vec{x}$ y $\vec{y}$, respectivamente. Se probará que $\left\{\pint{\vec{x_n}}{\vec{y_n}} \right\}$ converge a $\pint{\vec{x}}{\vec{y}}$ en $\mathbb{K}$.
        Se tiene que
        \begin{equation}
            \begin{split}
            ...
            \end{split}
        \end{equation}
        para todo $n\in\mathbb{N}$. Como $\left\{\vec{x_n} \right\}$ es convergente, es acotada. Luego existe $M_1>0$ tal que
        \begin{equation*}
    ...
    \begin{exa}
        Los espacios $L_2(S,\mathbb{K})$, $l_2(\mathbb{K})$ y todo espacio prehilbertiano de dimensión finita ($\mathbb{K}$) eson hilbretianos (ya que, todo espacio prehilbertiano de dimensión finita es isomorfo a $\mathbb{R}^k$, para algún $k\in\mathbb{N}$).
    \end{exa}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            ...
            \end{split}
        \end{equation*}
        Suponga que los k-vectores $\vec{x_1},...\vec{x_k}$ son ortogonales.
    ...
    Este resultado anterior es importante, pues en espacios donde la norma no venga de un producto escalar, no se cumple la igualdad.

    \begin{exa}
        Los vectores $\chi_{[0,1]}$ y $\chi_{[1,2]}$ son ortogonales en $L_2(\mathbb{R},\mathbb{R})$.
    \end{exa}

    \begin{exa}
        Los vectores $\sen$ y $\cos$ son ortogonales en $L_2([-\pi,\pi[,\mathbb{R})$. En efecot, veamos que
        \begin{equation*}
    ...
    \begin{exa}
        ...
        \begin{equation*}
            ...
            \end{split}
        \end{equation*}
        donde $\left\{s_n\right\}$ es la sucesión de sumas parciales, siendo $s_{2m}=0$ y $s_{2m-1}=\frac{1}{m}$. Por lo cual
        \begin{equation*}
