...
\begin{document}
    ...
    \begin{proof}
        ...
        \end{equation*}
        Luego, $\alpha\pi(\vec{x})$ es una proyección ortogonal de $\alpha\pi(\vec{x})$ sobre $M$, pero por unicidad de la proyección ortogonal, se tiene que $\pi(\alpha\vec{x})=\alpha\pi(\vec{x})$.
    ...
    \begin{proof}
        ...
        \begin{equation*}
            ...
            \end{split}
        \end{equation*}
        usando las dos propiedades de $\pi$. Por tanto, $\pi(\vec{x})$ es la proyección ortogonal de $\vec{x}$, es decir que $M$ es distinguido. La unicidad se sigue de la construcción.
    \end{proof}
    ...
    \begin{theor}[Teorema de Riesz]
        ...
        \begin{equation*}
            G_{\vec{y}}(\vec{y})=\pint{\vec{x}}{\vec{y}},\forall\vec{x}\in H
        \end{equation*}
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \begin{equation*}
                \abs{G_{\vec{y}}}=\abs{\pint{\vec{x}}{\vec{y}}}\leq\norm{\vec{x}}\norm{\vec{y}},\quad\forall\vec{x}\in H
            \end{equation*}
            (por Cauchy-Schwartz). Así que $G_{\vec{y}}\in H^*$. Además, $\norm{G_{\vec{y}}}\leq \norm{\vec{y}}$. Por otra, parte, si $\vec{y}\neq\vec{0}$, entonces
            \begin{equation*}
                G_{\vec{y}}(\vec{y})=\pint{\vec{y}}{\vec{y}}=\norm{\vec{y}}^2
            \end{equation*}
            pero, como el operador es continuo, se tiene que $G_{\vec{y}}\leq\norm{G_{\vec{y}}}\norm{\vec{y}}$. Por lo cual, $\norm{\vec{y}}\leq\norm{G_{\vec{y}}}$. Así pues, $\norm{G_{\vec{y}}}=\norm{\vec{y}}$.

            Si $\vec{y}=\vec{0}$, entonces $\norm{G_{\vec{y}}}=0=\norm{\vec{y}}$, pues $G_{\vec{y}}=0$.

            \item La aplicación $\cf{G}{H}{H^*}$, $\vec{y}\mapsto G_{\vec{y}}$ es semilinel, es decir que $G_{\alpha\vec{y}}=\conj{\alpha}G_{\vec{y}}$ y separa sumas. En efecto, sea $\vec{y}\in H$ y $\alpha\in\mathbb{K}$. Entonces:
            \begin{equation*}
                \begin{split}
