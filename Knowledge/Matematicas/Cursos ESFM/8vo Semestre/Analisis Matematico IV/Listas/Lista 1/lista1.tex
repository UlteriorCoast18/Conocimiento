    ...
    \begin{proof}
        ...
        \begin{equation*}
            \begin{split}
                ...
                =&\frac{1}{4}(\abs{\pint{A(\lambda\vec{x}+\lambda^{-1}A\vec{x})}{\lambda\vec{x}+\lambda^{-1}A\vec{x}}}+\abs{\pint{A(\lambda\vec{x}-\lambda^{-1}A\vec{x})}{\lambda\vec{x}-\lambda^{-1}A\vec{x}}})\\
                \leq&\frac{1}{4}(\norm{A(\lambda\vec{x}+\lambda^{-1}A\vec{x})}\norm{\lambda\vec{x}+\lambda^{-1}A\vec{x}}+\norm{A(\lambda\vec{x}-\lambda^{-1}A\vec{x})}\norm{\lambda\vec{x}-\lambda^{-1}A\vec{x}})\\
