...
\begin{document}
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \end{equation*}
            Afirmamos que la aplicación $\cf{\adj{T}}{H'}{H}$ está bien definida y es lineal continua. En efecto, si

            
            sean $\vec{x'},\vec{y'}\in H'$, entonces:
        \end{itemize}
    \end{proof}
