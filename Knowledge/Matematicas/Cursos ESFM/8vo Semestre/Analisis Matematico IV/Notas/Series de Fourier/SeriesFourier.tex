...
\begin{document}
    ...
    \begin{equation*}
        D_m(x)=\frac{1}{2\pi}\sum_{ k=-m}^m=\frac{1}{2\pi}\left[1+\sum_{ k=1}^m\left(e^{ ikx}+e^{ -ikx} \right) \right]=\frac{1}{2\pi}\left[2\Re\left(\sum_{ k=1}^m e^{ ikx} \right)-1 \right]
    \end{equation*}
    para todo $m\in\mathbb{N}^*$. Se tiene
    \begin{equation*}
        \begin{split}
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    sustituyendo en el núcleo de Dirichlet:
    \begin{equation*}
        D_m(x)=\frac{1}{2\pi}\frac{\sen\left(m+\frac{1}{2} \right)x}{\sen\frac{x}{2}}
    \end{equation*}
    ...
    \begin{theor}[\textbf{Teorema fundamental para la convergencia puntual de una serie de Fourier}]
        Sea $f\in\mathcal{L}_1^{2\pi}(\mathbb{C})$ y fijemos $x\in\mathbb{R}$. Para que la serie de Fourier de $f$ converja en $x$ a una suma $s(x)$ (finita), es necesario y suficiente que para algún $0<\delta<\pi$ se cumpla alguna de las dos condiciones siguientes:
        \begin{enumerate}
    ...
    \begin{proof}
        Probaremos que las integrales (1) y (2) son equivalentes (es decir que son una misma integral). En efecto,
        \begin{equation*}
            \begin{split}
                \int_{-\delta}^\delta \frac{f(x+t)-s(x)}{t}\sen\left(m+\frac{1}{2} \right)tdt&=\int_{-\delta}^0\frac{f(x+t)-s(x)}{t}\sen\left(m+\frac{1}{2} \right)tdt\\&+\int_0^\delta \frac{f(x+t)-s(x)}{t}\sen\left(m+\frac{1}{2} \right)tdt\\
        ...
        \begin{equation*}
            \begin{split}
                s_m(x)-s(x)&=\frac{1}{2\pi}\left[\int_{-s}^{s}\frac{f(x+t)-s(x)}{\sen\frac{t}{2}}\sen\left(m+\frac{1}{2} \right)tdt+\int_{s\leq|t|<\pi}\frac{f(x+t)-s(x)}{\sen\frac{t}{2}}\sen\left(m+\frac{1}{2} \right)tdt\right] \\
            \end{split}
        \end{equation*}
        Como $t\mapsto\frac{f(x+t)-s(x)}{\sen\frac{t}{2}}$ es integrable en $s\leq\abs{t}<\pi$, por el teorema de Riemman-Lebesgue la segunda integral tiende a cero conforme $m\rightarrow\infty$. Por lo tanto,
        \begin{equation*}
            \lim_{ m\rightarrow\infty}[s_m(x)-s(x)]=0\iff\lim_{ m\rightarrow\infty}\int_{-s}^{s}\frac{f(x+t)-s(x)}{2\sen\frac{t}{2}}\sen\left(m+\frac{1}{2} \right)tdt=0
        \end{equation*}
        y, veamos que
        \begin{equation*}
            \begin{split}
                \int_{-\delta}^{\delta}\frac{f(x+t)-s(x)}{2\sen\frac{t}{2}}\sen\left(m+\frac{1}{2} \right)tdt&=\int_{-\delta}^{\delta}\frac{f(x+t)-s(x)}{t}\sen\left(m+\frac{1}{2} \right)tdt\\&+\int_{-\delta}^{-\delta}\left(f(x+t)-s(x)\right)\left[\frac{1}{2\sen\frac{t}{2}}-\frac{1}{t} \right]\sen\left( m+\frac{1}{2} \right)tdt\\
            \end{split}
        \end{equation*}
        Pero,
        \begin{equation*}
            \begin{split}
                ...
                t\rightarrow0=&\frac{t-2\left(\frac{t}{2}-\frac{t^3}{48}+O(t^3) \right)}{2t(\frac{t}{2}-O(t))}\\
                t\rightarrow0=&\frac{\frac{t^3}{48}+O(t^3)}{t^2+2tO(t)}\\
                t\rightarrow0=&\frac{\frac{t^3}{48}+O(t^3)}{t^2+O(t^2)}\\
                t\rightarrow0=&\frac{t^3\left(\frac{1}{48}+\frac{O(t^3)}{t^2} \right)}{t^2(1+\frac{O(t^2)}{t^2})}\\
                t\rightarrow0=&\frac{t\left(\frac{1}{48}+\frac{O(t^3)}{t^2} \right)}{1+\frac{O(t^2)}{t^2}}\\
                t\rightarrow0=&0\\
            \end{split}
        \end{equation*}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            \begin{split}
                ...
                \Rightarrow \int_{0}^\delta\abs{\frac{f(x-t)-s(x)}{t}}dt+\int_{0}^\delta\abs{\frac{f(x+t)-s(x)}{t}}dt&=\int_{-\delta}^{\delta}\abs{\frac{f(x+t)-s(x)}{t}}dt<\infty\\
                \Rightarrow \int_{0}^\delta\abs{\frac{f(x+t)+f(x-t)-2s(x)}{t}}dt &=\int_{-\delta}^{\delta}\abs{\frac{f(x+t)-s(x)}{t}}dt<\infty\\
            \end{split}
        \end{equation*}
    \end{proof}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            0<t<\delta\Rightarrow\left\{
                \begin{array}{rl}
                    \abs{f(x+t)-d(x)}&\leq t\abs{f_d'(x)+1}\\
                    \abs{f(x-t)-d(x)}&\leq t\abs{f_i'(x)+1}\\
                \end{array}
            \right.
        \end{equation*}
    ...
    \begin{lema}[\textbf{Versión Uniforme del Teorema de Riemman-Lebesgue}]
        Si $\mathcal{F}$ es un conjunto relativamente compacto en $L_1^{2\pi}(\mathbb{C})$, entonces para todo $\varepsilon>0$ existe $N\geq0$ tal que
        \begin{equation*}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            \lambda\in\mathbb{R},\abs{\lambda}\geq N\Rightarrow\abs{\int_{-\pi}^\pi f_k(x)e^{i\lambda x}dx}<\frac{\varepsilon}{2},\forall k\in\natint{1,r}
        \end{equation*}
        Sea $f\in\mathcal{F}$ arbitario. Existe $k\in\natint{1,r}$ tal que $f\in B(f_k,\frac{\epsilon}{2})$, esto es
        \begin{equation*}
        ...
        \begin{equation*}
            \begin{split}
                \abs{\int_{-\pi}^\pi f(x)e^{ i\lambda x}dx}&\leq\abs{\int_{-\pi}^{\pi}(f(x)-f_k(x))e^{i\lambda x}dx}+\abs{\int_{-\pi}^\pi f_k(x)e^{ i\lambda x}dx}\\
                &<\N{1}{f-f_k}+\frac{\varepsilon}{2}\\
                &<\varepsilon\\
            \end{split}
        \end{equation*}
