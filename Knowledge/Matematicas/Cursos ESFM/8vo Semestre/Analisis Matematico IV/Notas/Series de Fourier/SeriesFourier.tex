...
\begin{document}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            ...
            \end{split}
        \end{equation*}
        donde la primera desigualdad es por el segundo teorema del valor medio. Y,
        \begin{equation*}
            \abs{\int_{ -\pi}^\pi e^{ -ikt}dt}=\abs{\frac{e^{ ik\pi}-e^{ ikx}}{ik}}\leq\frac{2}{\abs{k}}
        \end{equation*}
        ...
        \end{equation*}
        Tomando $A=\frac{1}{\pi}[2\abs{f(\pi)}+\abs{f(-\pi)}]>0$ se sigue el resultado.
    \end{proof}
