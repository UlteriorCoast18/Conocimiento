...
\begin{document}
    ...
    \begin{proof}
        Sea $\varepsilon>0$ y $(x_0,y_0)\in E\times E$. Tomemos $\delta=\sqrt{\varepsilon}$, entonces, si $(x,y)\in E\times E$ es tal que:
        \begin{equation*}
    ...
    \begin{theor}[\textbf{Desigualdad de Hölder Generalizada}]
        ...
        \end{equation*}
        entonces, si $f_1\in\mathcal{L}_{p_1}(\mathbb{R}^n,\mathbb{K}),f_2\in\mathcal{L}_{p_2}(\mathbb{R}^n,\mathbb{K}),...,f_n\in\mathcal{L}_{p_m}(\mathbb{R}^n,\mathbb{K})$, entonces $f_1\cdot f_2\cdots f_m\in \mathcal{L}_1(\mathbb{R}^n,\mathbb{K})$, y
        \begin{equation*}
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \begin{equation*}
                \begin{split}
                    ...
                    &\leq \N{p}{f}^{r-q}\N{g}{ r-p}\int_{\mathbb{R}^n}\abs{f}^p*\abs{g}^q(x)dx\\
                    &=\N{p}{f}^{r-q}\N{g}{ r-p}\left(\int_{\mathbb{R}^n}\abs{f}^p\right)\left(\int_{\mathbb{R}^n}\abs{g}^q\right) \\
                    &=\N{p}{f}^{r-q}\N{g}{ r-p}\N{p}{f}^{p}\N{g}{q}\\
        ...
        El caso $p=q=1$ es el teorema anterior, y por la conmutatividad de la convolución, no es necesaroi probar el caso $q=1$, $p>1$.
    \end{proof}
