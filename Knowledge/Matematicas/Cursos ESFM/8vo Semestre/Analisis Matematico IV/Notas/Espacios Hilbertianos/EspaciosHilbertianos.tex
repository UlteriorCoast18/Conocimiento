...
\begin{document}
    ...
    \begin{lema}[\textbf{Lema de los promedios}]
        Sea $S\subseteq\mathbb{R}^n$ medible, y sea $\cf{f}{S}{\mathbb{K}}$ medible e integrable en todo cojunto medible con medida finita dentro de $S$. Sea $F$ un conjunto cerrado en $\mathbb{K}$. Se supone que para todo $A\subseteq S$ medible tal que $0<m(A)<\infty$ se cumple lo siguiente:
        \begin{equation*}
    ...
    \begin{theor}
        ...
        \end{equation*}
        Entonces, $\phi_g$ es un funcional lineal continuo sobre $L_1(S,\mathbb{K})$. Además, la aplicación $\phi:g\mapsto \phi_g$ es una isometría lineal de $L_\infty(S,\mathbb{K})$ sobre $L_1(\mathbb{N},\mathbb{K})^*$.
    \end{theor}
