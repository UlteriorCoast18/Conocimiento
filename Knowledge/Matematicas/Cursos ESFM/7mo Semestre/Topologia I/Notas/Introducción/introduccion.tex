...
\begin{document}
    ...
    \begin{excer}
        ...
        \begin{enumerate}
            ...
            \item $\mathcal{B}_1=\left\{[a,b[\Big|a,b\in\mathbb{R},a<b \right\}$.
            \item $\mathcal{B}_1=\left\{]a,b[\Big|a,b\in\mathbb{R},a<b \right\}$.
            \item  $\mathcal{B}_1=\left\{B-K \Big|B\in\mathcal{B}_1 \right\}\cup\mathcal{B}_1$, con $K=\left\{\frac{1}{n}\Big|n\in\mathbb{N} \right\}$.
            \item $\mathcal{B}_1=\left\{]a,\infty[\Big|a\in\mathbb{R}\right\}$.
            \item $\mathcal{B}_1=\left\{]-\infty,b[\Big|b\in\mathbb{R} \right\}$.
            \item La topología de complementos finitos.
        \end{enumerate}
    \end{excer}
    ...
    \begin{propo}
        ...
        \begin{enumerate}
            ...
            \item Sea $A\subseteq Y$. Entonces $A$ es cerrado en $Y$ si y sólo si existe $C\subseteq X$ cerradp en $X$ tal que $A=Y\cap C$.
        \end{enumerate}
    \end{propo}

    \begin{proof}
        De (1): Es inmediata de la definción de subespacio de un espacio topológico.
