...
\begin{document}
    ...
    \begin{excer}
        Sean $(X,\tau)$ un espacio topológico y $\mathcal{B}$ una sub-base para $\tau$, y $D\subseteq X$ tal que $D\cap B\neq\emptyset$ para todo $B\in\mathcal{B}$ ¿Esto implica que $D$ es denso en $X$?
    \end{excer}
    ...
    Mis ejercicios de la sección: 3d).
