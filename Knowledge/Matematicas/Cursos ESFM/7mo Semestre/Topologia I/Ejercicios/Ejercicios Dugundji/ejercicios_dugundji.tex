...
\begin{document}
    \title{Ejercicios Dugundji Topology}
    ...
    \begin{excer}
        ...
        \begin{equation*}
            \left\{U\subseteq X\big| U\textup{ es abierto} \right\}
        \end{equation*}
